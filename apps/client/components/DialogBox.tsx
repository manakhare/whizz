...
export default function DialogBox({id, setEditMode, setDialogBox, setDeleted, index, triggerId}: {
  ...
  return (
    <div className='className="overflow-y-auto bg-amber-50 bg-opacity-70 flex overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full'>
